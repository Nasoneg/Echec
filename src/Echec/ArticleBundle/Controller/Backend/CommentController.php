...
class CommentController extends \ED\BlogBundle\Controller\Backend\CommentController
{
    /**
    ...
    private function getPaginated($paginator, $ajaxParams = array(), $templateParams = array())
    {
        ...
        $response = $paginator->paginate(
            $queryBuilder,
            'EchecArticleBundle:Comment/Comments:list',
            'EchecArticleBundle:Comment/Comments:paginationComments',
            $templateParams,
            Pagination::DOZEN,
            null,
            'EchecArticleBundle:Comment/Comments:paginationComments.html.twig',
            $ajaxParams
        );
