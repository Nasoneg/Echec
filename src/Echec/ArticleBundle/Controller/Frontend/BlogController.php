...
class BlogController extends \ED\BlogBundle\Controller\Frontend\BlogController
{
    /**
    ...
    public function indexAction()
    {
        ...
        $response = $paginator->paginate(
            ...
            'EchecArticleBundle:Frontend/Blog:index',
            'EchecArticleBundle:Frontend/Global:pagination',
            array(),
            Pagination::SMALL,
            null,
            $paginationTemplate = 'EchecArticleBundle:Frontend/Global:pagination.html.twig',
            array(),
            null
        );
    ...
    public function singleArticleAction($article)
    {
        ...
        {
            throw new NotFoundHttpException("Désolé, cet article n'est pas disponible!");
        }
        ...
        return $this->render("EchecArticleBundle:Frontend/Blog:singleArticle.html.twig",
            array(
                'article' => $article,
    ...
    public function archiveAction($yearMonth)
    {
        ...
        {
            throw new NotFoundHttpException("Archive invalide.");
        }
