...
class GroupController extends Controller
{
    ...
    public function showAction($groupName)
    {
        ...
        return $this->render('EchecUserBundle:Group:show.html.twig', array(
            'group' => $group,
        ));
    }
    ...
    public function editAction(Request $request, $groupName)
    {
        ...
        return $this->render('EchecUserBundle:Group:edit.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('EchecUserBundle:Group:new.html.twig', array(
            'form' => $form->createView(),
        ));
    }
