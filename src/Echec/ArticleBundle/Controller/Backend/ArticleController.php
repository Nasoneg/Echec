...
class ArticleController extends \ED\BlogBundle\Controller\Backend\ArticleController
{
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render("EchecArticleBundle:Article:create.html.twig",
            array(
    ...
    public function autosaveAction(Request $request, $article)
    {
        ...
        if($this->container->get('security.authorization_checker')->isGranted('EDIT_ARTICLE', $article) === false)
        {
            return new JsonResponse( array(
                "success" => false,
                "message" => "Ce contenu est actuellement indisponible, vous n\'avez peut être pas les droits nécessaires."
            ));
        }
    ...
    private function getPaginated($paginator, $ajaxParams = array(), $folder='Media')
    {
        ...
        $response = $paginator->paginate(
            $queryBuilder,
            'EchecArticleBundle:Article/' . $folder. ':list',
            'EchecArticleBundle:Global:pagination',
            array(),
            Pagination::DOZEN,
            null,
            'EchecArticleBundle:Global:pagination.html.twig',
            $ajaxParams,
    ...
    public function listAction(Request $request)
    {
        ...
        $response = $paginator->paginate(
            $articles,
            'EchecArticleBundle:Article:list',
            'EchecArticleBundle:Global:paginationClassic',
            array('orderBy'=>$orderBy, 'order'=>$order),
            Pagination::MEDIUM,
            null,
            'EchecArticleBundle:Global:paginationClassic.html.twig',
            array()
        );
    ...
    public function showAction(Request $request, Article $article)
    {
        ...
        return $this->render("EchecArticleBundle:Article:show.html.twig",
            array(
                'article' => $article,
                'form' => $form->createView(),
                'comments' => $comments
